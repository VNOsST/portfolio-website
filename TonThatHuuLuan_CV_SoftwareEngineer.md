...
**SUMMARY**  
Software Engineer with experience building web, mobile, and cloud-based applications using TypeScript, React/Next.js, Node.js, and Python. Experienced in developing scalable frontend and backend systems, improving engineering workflows, and contributing across product and platform development.
